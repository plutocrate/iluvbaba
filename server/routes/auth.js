...
function tryDb() { try { return require('../models/db'); } catch(e) { return null; } }
...
router.post('/change-password', authMiddleware, async (req, res) => {
  ...
  } catch(e) { console.error('Change password error:', e); res.status(500).json({ error: 'Failed to change password' }); }
});
